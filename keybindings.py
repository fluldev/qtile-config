...
keys = [
    ...
    Key([mod], "m", lazy.spawn(email), desc="Spawn email client."),
    Key([mod], "n", lazy.spawn(notes), desc="Spawn notes client."),
    Key([mod], "space", lazy.spawn(launcher), desc="Spawn a command using a prompt widget"),
    Key([mod], "BackSpace", lazy.spawn(window_switcher), desc="Spawn window switcher"),
